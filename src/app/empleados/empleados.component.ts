...
export class EmpleadosComponent implements OnInit {
  ...
  listEmpleados: Empleado[] = [
    ...
    { legajo: 2, nombre: 'Maria', apellido: 'Perez', genero: 'Femenino', salario: 85000 },
    { legajo: 3, nombre: 'Nicolas', apellido: 'Perez', genero: 'Masculino', salario: 90000 },
    { legajo: 4, nombre: 'Fernando', apellido: 'Perez', genero: 'Masculino', salario: 55000 },
    { legajo: 5, nombre: 'Rocio', apellido: 'Perez', genero: 'Femenino', salario: 60000 }
